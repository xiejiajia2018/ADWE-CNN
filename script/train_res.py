...
class Model(torch.nn.Module):
    def __init__(self, gen_emb, domain_emb,offset, num_classes=3, dropout=0.5, crf=False):
        ...
        self.conv1 = torch.nn.Conv1d(450, 256, 3, padding=1)
        self.conv2 = torch.nn.Conv1d(450, 256, 3, padding=1)
        ...
        self.conv3 = torch.nn.Conv1d(512, 256, 3, padding=1)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--lr', type=float, default=0.00022)
